...
void draw() {
  ...
  if (menu.page == 1 || menu.page == 2 || menu.page == 3) {
    menu.display();
  }
  ...
  if (menu.page == 0) {
    if (gameOver) {
      ...
      if (nameCharsWritten == 3) {
        text("Press SPACE to go", (width - textWidth("Press SPACE to go"))/2, height - 50);
        text("back to main menu", (width - textWidth("back to main menu"))/2, height-15);
      } else {
...
if (mouseX >= pauseButtonx && mouseX <= pauseButtonx + pauseButtonWidth && mouseY >= pauseButtony && mouseY <=pauseButtony + pauseButtonHeight) {
    ...
    if (mouseX >= pauseButtonx && mouseX <= pauseButtonx + pauseButtonWidth && mouseY >= pauseButtony && mouseY <=pauseButtony + pauseButtonHeight && mousePressed == true) {
      menu.page = 3;
    }
